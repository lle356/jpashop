...
public class initDb {
    ...
    static class InitService {
        ...
        public void dbInit2() {
            ...
            Book book1 = crateBook("SPRING1 BOOK", 20000, 200);
            em.persist(book1);

            Book book2 = crateBook("SPRING2 BOOK", 40000, 300);
            em.persist(book2);
        ...
        private static Book crateBook(String name, int price, int stockQuantity) {
            Book book1 = new Book();
            book1.setName(name);
